...
## 🔴 ACTIVE TASKS (Website Development Sprint)

**Multiple tasks in flight — tracked by phase.**
...
Tasks ready to become active when current task completes. **Ordered by dependency (AI employees can work in parallel at top, human decisions at bottom).**

### 🟢 AI EMPLOYEES — Can Start Immediately (No Dependencies)

| ID | Title | Priority | Owner | Est Hours | Dependencies |
|:---|:---|:---|:---|---:|:---|
| TASK-002 | [[Tasks/TASK-002-create-brand-identity\|Create Brand Identity System]] | P0 | LUMEN | 8 | None |
| TASK-010 | [[Tasks/TASK-010-write-homepage-copy\|Write Homepage Copy]] | P0 | CMO | 6 | None |

### 🟡 FOUNDATION — Requires Tech Stack Decision First

| ID | Title | Priority | Owner | Est Hours | Dependencies |
|:---|:---|:---|:---|---:|:---|
| TASK-001 | [[Tasks/TASK-001-finalize-tech-stack\|Finalize Website Tech Stack]] | P0 | CTO | 4 | None (FOUNDER decision) |
| TASK-004 | [[Tasks/TASK-004-setup-design-system\|Set Up Design System & Component Library]] | P0 | ENG-FE | 8 | TASK-001, TASK-002, TASK-003 |
| TASK-005 | [[Tasks/TASK-005-setup-asset-pipeline\|Set Up Asset Pipeline & CDN]] | P1 | ENG-BE | 6 | TASK-001, TASK-003 |

### 🟠 VISUAL ASSETS — Parallel to Foundation

| ID | Title | Priority | Owner | Est Hours | Dependencies |
|:---|:---|:---|:---|---:|:---|
| TASK-006 | [[Tasks/TASK-006-create-hero-illustration\|Create Hero Illustration]] | P1 | LUMEN | 6 | TASK-002, TASK-005 |
| TASK-007 | [[Tasks/TASK-007-create-marketing-illustrations\|Create Marketing Illustrations (12 Total)]] | P1 | LUMEN | 16 | TASK-002, TASK-005, TASK-006 |
| TASK-008 | [[Tasks/TASK-008-create-iconography\|Create Iconography System (100+ Icons)]] | P2 | LUMEN | 12 | TASK-002, TASK-005 |
| TASK-009 | [[Tasks/TASK-009-produce-explainer-video\|Produce Explainer Video (90 seconds)]] | P1 | FLUX | 12 | TASK-002, TASK-005, TASK-006 |

### 🔴 CORE PAGES — Build in Sequence

| ID | Title | Priority | Owner | Est Hours | Dependencies |
|:---|:---|:---|:---|---:|:---|
| TASK-011 | [[Tasks/TASK-011-build-global-components\|Build Global Components (Nav & Footer)]] | P0 | ENG-FE | 8 | TASK-003, TASK-004, TASK-008 |
| TASK-012 | [[Tasks/TASK-012-build-homepage\|Build Homepage]] | P0 | ENG-FE | 24 | TASK-003-011 |
| TASK-013 | [[Tasks/TASK-013-build-product-pages\|Build Product Pages (6 Employees)]] | P1 | ENG-FE | 16 | TASK-011, TASK-012 |
| TASK-014 | [[Tasks/TASK-014-build-pricing-page\|Build Pricing Page with Stripe]] | P1 | ENG-FE | 12 | TASK-011, TASK-012, TASK-013 |
